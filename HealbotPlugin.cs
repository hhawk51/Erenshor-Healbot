...

    {
...

        {
...

            {
                ...
                autoTargetOverlay.SetVisible(false);
        ...
        public (string primary, string shift) GetOverlayBinding(PointerEventData.InputButton button)
...

        {
...

            {
                ...
                case PointerEventData.InputButton.Left:
                    ...
                    return (leftClickSpell?.Value ?? string.Empty, shiftLeftClickSpell?.Value ?? string.Empty);
                ...
                case PointerEventData.InputButton.Right:
                    ...
                    return (rightClickSpell?.Value ?? string.Empty, shiftRightClickSpell?.Value ?? string.Empty);
                ...
                case PointerEventData.InputButton.Middle:
                    ...
                    return (middleClickSpell?.Value ?? string.Empty, shiftMiddleClickSpell?.Value ?? string.Empty);
...

        {
            ...
            autoTargetOverlay?.RefreshBindings();
...

        {
            ...
            var candidates = groupMembers
                ...
                .Where(gm => gm != null && gm.stats != null && gm.stats.CurrentMaxHP > 0 && gm.stats.CurrentHP > 0)
            ...
            var best = candidates.FirstOrDefault(x => x.Fraction > 0f);
...

        {
            ...
            bool shouldShow = autoEnabled && IsCharacterLoggedIn() && !IsLauncherButtonHidden;



            autoTargetOverlay.SetVisible(shouldShow);
